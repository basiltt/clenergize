...
> Clenergize Audit Identity & Access Management Service Compliance Service
...
- **General Health**: http://localhost:3007/v1/health
- **Liveness Probe**: http://localhost:3007/v1/health/live
- **Readiness Probe**: http://localhost:3007/v1/health/ready
