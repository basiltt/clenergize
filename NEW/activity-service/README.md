...
> Clenergize Activity Data Ingestion Service
...
- **General Health**: http://localhost:3004/v1/health
- **Liveness Probe**: http://localhost:3004/v1/health/live
- **Readiness Probe**: http://localhost:3004/v1/health/ready
