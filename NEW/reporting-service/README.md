...
> Clenergize Reporting Identity & Access Management Service Analytics Service
...
- **General Health**: http://localhost:3006/v1/health
- **Liveness Probe**: http://localhost:3006/v1/health/live
- **Readiness Probe**: http://localhost:3006/v1/health/ready
