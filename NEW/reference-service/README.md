...
> Clenergize Reference Data Management Service
...
- **General Health**: http://localhost:3003/v1/health
- **Liveness Probe**: http://localhost:3003/v1/health/live
- **Readiness Probe**: http://localhost:3003/v1/health/ready
