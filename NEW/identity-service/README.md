...
> Clenergize Identity & Access Management Service

## Overview

The Identity Service manages user authentication, authorization, and access control for the Clenergize platform. It provides:
...
- **General Health**: http://localhost:3001/v1/health
- **Liveness Probe**: http://localhost:3001/v1/health/live
- **Readiness Probe**: http://localhost:3001/v1/health/ready
