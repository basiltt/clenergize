...
> Clenergize Organization Identity & Access Management Service Project Management Service
...
- **General Health**: http://localhost:3002/v1/health
- **Liveness Probe**: http://localhost:3002/v1/health/live
- **Readiness Probe**: http://localhost:3002/v1/health/ready
